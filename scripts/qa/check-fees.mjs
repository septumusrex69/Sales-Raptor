 ...
 *
 * SETTLED, 10 September 2026. The business confirmed R502 was captured incorrectly on their side:
 * the gazette says R509 and Swordfish is wrong. The 2020 schedule therefore stands as it is, and
 * this expectation with it.
 *
 * What changed instead is which figure the balance uses. "All Payments Incl Balances" carries the
 * commission actually charged on each payment, and where that is present it wins over the
 * computed one — 79 payments were billed at the R502 maximum between December 2023 and March
 * 2026, and recomputing them from the gazette would show a balance no debtor was ever billed.
 * The schedule below governs what Raptor charges itself; the recorded figure governs history.
 */
