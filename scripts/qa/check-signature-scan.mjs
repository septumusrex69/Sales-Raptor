...
check('debtor gives a new number in Afrikaans',
  values('Goeie dag. Ek het julle brief ontvang oor die Edgars rekening. Ek kan R600 per maand betaal vanaf 30 Oktober. My nuwe nommer is 083 441 9922.'),
  ['mobile:083 441 9922'])
...
check('no spaces', values('cell 0834419922'), ['mobile:083 441 9922'])
...
check('a signature block with two numbers',
  values(['Regards', 'J M van Wyk', 'Mobile: 083 441 9922', 'Work: 021 555 1234'].join('\n')),
  ['mobile:083 441 9922', 'phone:021 555 1234'])

check('the same number twice is offered once',
  values('Call 083 441 9922 or 0834419922'),
  ['mobile:083 441 9922'])
...
check('an Afrikaans rekening number', values('Rekening 0834419922 is verkeerd.'), [])
...
const reply = [
  'Thanks, my number is 083 441 9922.',
  '',
...
check('only the sender\'s own number, not the quoted chain', values(reply), ['mobile:083 441 9922'])
...
check('Outlook header form cuts the block',
  topBlock('My cell is 083 441 9922.\n\nFrom: Someone\nSent: Monday\nMobile: 082 111 2222').includes('082'),
  false)
...
check('a picture signature still yields its tel: link',
  linked('<p>Regards</p><a href="tel:+27834419922"><img src="cid:sig.png" alt="signature"></a>'),
  ['mobile:083 441 9922'])

check('tel: in local form', linked('<a href="tel:0215551234">Call</a>'), ['phone:021 555 1234'])
check('tel: with spaces and dashes', linked('<a href="tel:+27 83-441-9922">x</a>'), ['mobile:083 441 9922'])
...
check('a tracking link is not a contact detail',
  linked('<a href="https://example.com/track?x=0834419922">unsubscribe</a>'), [])
check('tel: that is not a real SA number', linked('<a href="tel:911">x</a>'), [])
check('the same link twice is offered once',
  linked('<a href="tel:0834419922">a</a><a href="tel:+27834419922">b</a>'),
  ['mobile:083 441 9922'])

check('nothing out of the quoted HTML chain',
  linked('<a href="tel:0834419922">mine</a><blockquote><a href="tel:0219998888">theirs</a></blockquote>'),
  ['mobile:083 441 9922'])
check('nothing out of an Outlook reply header',
  linked('<a href="tel:0834419922">mine</a><div id="divRplyFwdMsg"><a href="tel:0219998888">theirs</a></div>'),
  ['mobile:083 441 9922'])
check('nothing out of a gmail quote',
  linked('<a href="tel:0834419922">mine</a><div class="gmail_quote"><a href="tel:0219998888">x</a></div>'),
  ['mobile:083 441 9922'])
...
check('a number written AND linked is offered once',
  mergeCandidates(
    findContactDetails('My number is 083 441 9922.'),
    findLinkedDetails('<a href="tel:+27834419922">x</a>'),
  ).map((c) => c.value),
  ['083 441 9922'])

check('text and links both contribute',
  mergeCandidates(
    findContactDetails('Call me on 083 441 9922.'),
