 ...
 * 0825550182 comes back as 825550182 — 627 of the 1,706 numbers in this workbook. The only
 * symptom is a collector saying the number does not work.
 */
check('a mobile that lost its zero gets it back', phoneNumber('825550182'), '0825550182')
check('and one starting 7', phoneNumber('725550137'), '0725550137')
check('and one starting 6', phoneNumber('665550183'), '0665550183')
check('a landline too — nine digits is nine digits', phoneNumber('115550123'), '0115550123')
...
check('an international number is left alone', phoneNumber('263 774 555 012'), '263 774 555 012')
...
const dialable = only(oneLead('common', { ...LEAD, 'Cell': '825550182' }))
check('and it reaches the lead that way', dialable.mobile, '0825550182')
