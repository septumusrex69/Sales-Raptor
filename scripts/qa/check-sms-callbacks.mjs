 ...
 *
 *   submit   .../submit/single/?api_token=xxx&da=27832573344&ud=Hello+World&id=01
...
const dlr = get('userid=bfm1abcd2efg&status=DELIVRD&da=27832573344&ts=2026-09-14T09:31:00')
...
const mo = get('userid=bfm1abcd2efg&sa=27832573344&ud=Please+stop+calling+me')
check('a reply carries our reference', pick(params(mo), REFERENCE_KEYS), 'bfm1abcd2efg')
check('a reply carries the number', pick(params(mo), MSISDN_KEYS), '27832573344')
