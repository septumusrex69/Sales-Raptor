...
check('quoted-printable: a soft line break is not a line break',
  decodeQuotedPrintable('my number is 083 441 =\r\n9922').toString('utf8'),
  'my number is 083 441 9922')
...
const fetched = {
  bodyParts: new Map([
    ['1.1.1', Buffer.from('Goeie dag. My nuwe nommer is 083 441 =\r\n9922.')],
    ['1.1.2', Buffer.from('<p>Goeie dag.</p><a href=3D"tel:0834419922">x</a>')],
...
check('the text is decoded and the soft break healed',
  body.text, 'Goeie dag. My nuwe nommer is 083 441 9922.')
check('the HTML is kept too, because that is where an image signature hides its tel: link',
  body.html.includes('href="tel:0834419922"'), true)
